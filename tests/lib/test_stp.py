...
class TestLibSetup(unittest.TestCase):
    ...
    def test__init__(self):
        _ = Setup(name=self.setup_name, prj_name=self.setup_name, setups_folder=OpenBST.setups_folder(),
    ...
    def test_setup_name(self):
        setup = Setup(name=self.setup_name, prj_name=self.setup_name, setups_folder=OpenBST.setups_folder(),
                      force_setup_creation=True)
